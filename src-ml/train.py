...
def readData():
    ...
    with open('train_(n-6).csv') as File:
...
def createModel():
    inp=Input(shape=(20,))
    layer1=Dense(100,activation='relu', kernel_initializer='glorot_normal')(inp)
    layer2=Dense(200,activation='relu', kernel_initializer='glorot_normal')(layer1)
    layer3=Dense(200,activation='relu', kernel_initializer='glorot_normal')(layer2)
    layer4=Dense(50,activation='relu', kernel_initializer='glorot_normal')(layer3)
...
def trainModel(model, X, Y):
    ...
    model.fit(X, Y,epochs=350,batch_size=32,callbacks=callbacks_list,validation_data=(X_test, Y_test),verbose=2)
